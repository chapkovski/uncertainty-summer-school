    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send', otree.db.models.CurrencyField(null=True, verbose_name='How much money you would like to send to your partner?')),
                ('send_back', otree.db.models.CurrencyField(null=True, verbose_name='How much money you would like to send back?')),
